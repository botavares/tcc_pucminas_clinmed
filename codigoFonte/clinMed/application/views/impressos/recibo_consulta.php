...
<!DOCTYPE html>
	...
	<div id="pagina" style="z-index:99;">
		...
		<div id="informacao">
			<p>
				Recebi de <?php echo $dadosRecibo[0]["ds_nome_cliente"]?> a quantia de <?php echo $valor?> (<?php echo $valorExtenso?>), referente ao valor da CONSULTA MÉDICA registrada em nossa clínica sob número <?php echo $dadosRecibo[0]["ds_numero_consulta"]?> no dia <?php echo $mesExtenso?>.
			</p>
		</div>
		<div id="assinatura">
