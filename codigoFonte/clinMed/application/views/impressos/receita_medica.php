...
<!DOCTYPE html>
	...
	<div id="pagina" style="z-index:99;">
		...
		<h3>RECEITA MÉDICA <?php // echo $tipoEmpresa?></h3>
		<div>
		...
		<div id="informacao">
			<h3> Medicamentos</h3>
			<?php foreach($receitaMedica as $medicamento){?>
				<div>
					<p class="item"><?php echo $medicamento["ds_nome_generico"]." (".$medicamento["ds_nome_medicamento"].") - ".$medicamento["ds_apresentacao"]?></p>
					<p class="descricao"><?php echo $medicamento["ds_posologia"]?></p>
				</div>
			<?php } ?>
