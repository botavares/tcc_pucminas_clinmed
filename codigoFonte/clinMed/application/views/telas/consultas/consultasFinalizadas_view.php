			...
			<table id="datatable-fixed-header" class="table table-striped table-bordered">
				...
				<tbody>
					...
					<tr>
						...
						<td align="center"><a class="btn btn-success" href="<?php echo base_url().'Consultas/iniciarConsultas/'.$keyConsultas['pk_id_cliente'].'-'.$keyConsultas['ds_tipo_atendimento'].'-'.$numeroConsulta.'-'.$keyConsultas['fk_id_profissional']?>">REVER CONSULTA</a>
						</td>
					</tr>
						<?php } ?>
				</tbody>
			</table>
			<a href="<?php echo base_url()."Consultas/formAtendimentoConsultas/1"?>" class="btn btn-primary">Consultas do dia</a>
		</div>
	</div>
</div>