...
<div class="right_col" role="main">
	<div class="x_panel">
		<div class="x_content">
			<div class="x_title">
				<h2>Consultas do dia <?php echo date("d/m/Y")?> </h2>
			...
			<table id="datatable-fixed-header" class="table table-striped table-bordered">
				...
				<tbody>
					...
					<tr>
						...
						<td align="center"><a class="btn btn-success" href="<?php echo base_url().'Consultas/iniciarConsultas/'.$keyConsultas['pk_id_cliente'].'-'.$keyConsultas['ds_tipo_atendimento'].'-'.$numeroConsulta.'-'.$keyConsultas['fk_id_profissional']?>">INICIAR CONSULTA</a>
						</td>
					</tr>
						<?php } ?>
				</tbody>
			</table>
			<a href="<?php echo base_url()."Consultas/formAtendimentoConsultas/2"?>" class="btn btn-primary">Todas as Consultas</a>
