		...
		<div class="x_content">
			...
			<div>
				...
				<label class="green ml-5 ta-right">
					<?php
						echo $primeiraConsulta == FALSE ? "<a class='btn btn-primary btn-sm' href='".base_url()."Medicos/historicoPaciente/".$idCliente."/".$idMedico."' target='_blank' ><i class='fas fa-notes-medical fa-2x'></i> PRONTUÁRIO</a>":"<a></a>";
					?>
				</label>
			...
			<div class="modal-header">
      		...
      		<div class="modal-body">
        		<p class="font30 blue"><i class="font35 amarelo fas fa-question-circle"></i>  Deseja finalizar a Consulta?</p>
		  		<form method="POST" action="<?php echo base_url('Medicos/finalizarConsulta/')?>">
					...
					<div class="modal-footer">
						...
						<a class="btn btn-warning bold" href="<?php echo base_url()."Medicos/formAtendimentoConsultas"?>">Tela Inicial</a>
