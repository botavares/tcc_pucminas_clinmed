			...
			<div class="x_panel">
				<div class="x_content">
					...
					<div class="ferramentas col-lg-12 col-md-12 col-sm-12 col-xs-12" id="ferramentas-administrador">
						...
						<div class="icones col-md-3 col-xs-6">
							<a href="<?php echo base_url()."Especialidades"?>">
								<img src="<?php echo base_url()."external/img/equipe.png"?>" alt="Gerenciar especialidades médicas" title="Cadastrar as especialidades médicas">
					...
					<div class="ferramentas" id="ferramentas-medicos">
						...
						<div class="icones col-md-3  col-xs-6">
							<a href="<?php echo base_url()."Consultas/formAtendimentoConsultas"?>">
						...
						<div class="icones col-md-3  col-xs-6">
							<a href="<?php echo base_url()."Consultas/formPacienteHistorico"?>">
