			...
			<section id="menu-lateral" alt="menu lateral">
				...
				?>
					...
					<ul class="nav side-menu">
						...
						<li>
							<a href="<?php echo base_url()."Consultas/formAtendimentoConsultas"?>"><i class="fas fa-stethoscope fa-2x"></i><span class="label-side-menu">Iniciar Consulta</span> </span></a>
						</li>

						<li>
							<a href="<?php echo base_url()."Consultas/formPacienteHistorico"?>"><i class="fas fa-book-medical fa-2x"></i><span class="label-side-menu">Prontuários Pacientes</span> </span></a>
						</li>
						<li>
